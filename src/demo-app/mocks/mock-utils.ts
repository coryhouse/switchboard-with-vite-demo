import { Handler, HandlerConfig } from "../demo-app-types";
...
// Returns 0 otherwise.
export function getDelay(config: HandlerConfig, endpointDelay?: number) {
...
export function getUser(config: HandlerConfig) {
